        ...
        <div className="relative flex w-full flex-col min-h-screen space-y-2 lg:space-y-6 justify-between mx-auto">
          ...
          <div className="w-full bg-[#8866ee] h-fit rounded-xl overflow-hidden ">
            ...
            <div className="flex justify-between bg-[#6644cc] p-2 lg:px-4">
              <a href="https://github.com/dhrmkj" title={"@dhrmkj"}>
              ...
              <a
                href="https://www.linkedin.com/in/dharmik-jadav-064421248/"
                title={"linkedIn"}
              >
                <div
              ...
              <a href="mailto:dhrmkjdv@gmail.com" title={"@dhrmkjdv@gmail.com"}>
                <div className="m-2 h-8 w-8 hover:scale-125">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
              ...
              <a
                href="https://twitter.com/Lunch__enjoyer"
                title={"@Lunch_enjoyer"}
              >
                <div className="m-2 h-8 w-8 hover:scale-125">
                  <svg
          ...
          <div className="bg-[#44aadd] w-full h-fit rounded-xl overflow-hidden">
            ...
            <div className="flex bg-[#2299bb] justify-between p-2 lg:px-4 items-center">
              ...
              <div className="w-8 h-8 m-2 hover:scale-125">
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <rect fill="#3179c6" height="512" rx="256" width="512" />
                  <path
                    clip-rule="evenodd"
